...
void drawCube() {
	...
	glBegin(GL_QUADS);
	{
		...
		glTexCoord2f(1, 0); glVertex3f(points[5][0], points[5][1], points[5][2]);
		glTexCoord2f(0, 0); glVertex3f(points[6][0], points[6][1], points[6][2]);
		glTexCoord2f(0, 1); glVertex3f(points[7][0], points[7][1], points[7][2]);

		// Left (CDHg)
		glTexCoord2f(1, 1); glVertex3f(points[2][0], points[2][1], points[2][2]);
		glTexCoord2f(1, 0); glVertex3f(points[3][0], points[3][1], points[3][2]);
		glTexCoord2f(0, 0); glVertex3f(points[7][0], points[7][1], points[7][2]);
		glTexCoord2f(0, 1); glVertex3f(points[6][0], points[6][1], points[6][2]);

		// Right (ABFE)
		glTexCoord2f(1, 1); glVertex3f(points[0][0], points[0][1], points[0][2]);
		glTexCoord2f(1, 0); glVertex3f(points[1][0], points[1][1], points[1][2]);
		glTexCoord2f(0, 0); glVertex3f(points[5][0], points[5][1], points[5][2]);
		glTexCoord2f(0, 1); glVertex3f(points[4][0], points[4][1], points[4][2]);
		...
		// Bottom (BCGF)
		glTexCoord2f(1, 1); glVertex3f(points[1][0], points[1][1], points[1][2]);
		glTexCoord2f(1, 0); glVertex3f(points[2][0], points[2][1], points[2][2]);
		glTexCoord2f(0, 0); glVertex3f(points[6][0], points[6][1], points[6][2]);
...
void buildMainTower() {
	...
	glPushMatrix();
	{
		...
		initTexture("res/ice-cream-pattern-wafle.bmp");
		drawCube();
	}
	glPopMatrix();
	glPushMatrix();
	{
		...
		initTexture("res/ice-cream-pattern-wafle-choc.bmp");
		drawPyramid();
	}
	glPopMatrix();
}
...
void buildBase() {
	initTexture("res/vanilla-ice-cream.bmp");
	//glColor3f(0.5f, 0.5f, 0.3f);
	glPushMatrix();
	{
	...
	initTexture("res/chocolate-ice-cream.bmp");
...
void buildBridgeFixed() {
	initTexture("res/waffle-side-short-horizontal.bmp");
...
void buildBridgeSupport() {
	initTexture("res/cherry-red.bmp");
